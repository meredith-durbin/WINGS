...
def run_isim_single(row, my_config):
    input_dir = my_config['input_dir']
    catalog_type = my_config['catalog_type']
    ...
    if catalog_type == 'pyananke':
        ...
        if 'lsstsim' in input_dir:
            name_template = 'lsstsim_{:d}_isim.ecsv'
    ...
    t_bg = read_isim_input_catalogs(hplist_bg, my_config['background_dir'], '{:d}.ecsv', catalog_type='isim', 
